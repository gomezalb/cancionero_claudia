...
```bash
# Clonar el repo
git clone https://github.com/gomezalb/cancionero_claudia.git
cd cancionero_claudia
...
2. Regenerar el token `cancionero-claudia-admin`
...
```js
// sw.js
const CACHE_VERSION = "cancionero-claudia-v4"; // ← incrementar este número
```
